    ...
    function(window, document, undefined, framework) {
        ...
        var COMPATIBILITY = (function() {
            ...
            return {
                ...
                /**
                 * Gets the _vendor-prefixed CSS property by the given name.
                 * For example the given name is "transform" and you're using a old Firefox browser then the returned value would be "-moz-transform".
                 * If the browser doesn't need a _vendor-prefix, then the returned string is the given name.
                 * If the browser doesn't support the given property name at all (not even with a _vendor-prefix) the returned value is null.
                 * @param propName The unprefixed CSS property name.
                 * @returns {string|null} The _vendor-prefixed CSS property or null if the browser doesn't support the given CSS property.
